...
const barList = ["Amber ale", "Angostura bitters", "Campari", "Coco Lpez", "Cointreau", "Green Chartreuse", "Peychauds bitters", "Pimms", "apple cider", "baking spice aromatic bitters", "brandy", "butter", "cachaa", "calvados", "cardamom pods", "cinnamon sticks", "cinnamon syrup", "coffee liqueur", "cranberry preserves", "dark brown sugar", "demerara syrup", "dry vermouth", "egg white", "eggs", "gin", "ginger", "ginger beer", "grapefruit juice", "grated nutmeg", "heavy cream", "hot coffee", "hot milk", "ice", "lemon", "lemon juice", "lemon shrub", "lime", "lime juice", "madeira or sherry", "maple syrup", "maraschino", "mint leaves", "orange bitters", "orange liqueur", "orange zest", "peach liqueur", "pineapple or pineapple juice", "prosecco", "red wine", "ruby port", "rum", "simple syrup", "soda water", "sparkling wine", "strawberry", "sugar", "sweet vermouth", "teapsoon cloves", "tequila", "vodka", "water", "whiskey", "whole allspice", "whole cloves", "whole nutmeg"]
