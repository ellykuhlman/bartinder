...
const spring = new TasteAttr('Spring', 'i', ['mint', 'egg white', 'basil', 'celery'], []);
...
const cocktailAttributes = [brandy, gin, rum, tequila, vodka, whiskey, autumnal, spring, bitter, bubbly, herbal, citrus, tropical, refreshing, boozy];
const myAttributes = [];
const topMenu = []
var myBar;
var myMenu;
